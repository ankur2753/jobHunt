# API Fallback & Model Cascading To-Do List
...
- [x] Hook the custom loop into `apply_custom_job.py`, removing `AgentRuntime.invoke()`.

**Note:** To run this custom API fallback, you will need to add `LLM_API_KEY` and `LLM_BASE_URL` to your `.env` file and install the python package: `pip install openai`
